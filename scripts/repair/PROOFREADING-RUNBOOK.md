# IELTS 题库校对 · 第三轮执行手册（组级：题目说明 + 选项文字）

> 项目：`C:\Users\15pro\Desktop\MyProject\IELTS Workspace`
> 本手册**只讲第三轮**。第一轮（题干 + 答案键）已做完 2790 处；第二轮组级校对
> 已做完 59 工单 / 436 组，内容缺口 1638 → 1153。本轮是第二轮剩下的部分，
> 流程完全一样，只是工单列表重新生成过。
> 相关章节已从本手册删除，不要再去找。
> 规则由主会话制定，你在规则里跑。脚本已经写好，**不要自己写脚本**。
