...
with sync_playwright() as playwright:
    ...
    page.get_by_role("button", name="Listening", exact=True).click()
    ...
    page.get_by_role("button", name="Reading", exact=True).click()
    page.get_by_placeholder("搜索题目").fill("Cambridge IELTS 10 Academic Test 1 Reading")
