/**
 * SVG charts for the workspace pages — a straight port of the desktop
 * `components/Charts.tsx`. Same geometry, same rule: only real measured
 * values are plotted; missing data renders an empty state, never a guess.
 */
import { Icon, type IconName } from "./ReviewShared";
import { rawNeededForBand, rawToBand } from "../lib/band";
import type { AnalyticsPoint, ModuleKind } from "../types";
